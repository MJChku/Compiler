...
%token FOR WHILE IF GETI GETC GETS PUTI PUTS PUTC PUTI_ PUTS_ PUTC_ RETURN ARRAY 
%nonassoc IFX
%nonassoc ELSE
...
$5, $7); }
	...
	| ARRAY VARIABLE dimension ';' { $$ = opr(ARRAY, 1, listnode($2,$3));}	
	;
dimension: 
	| '[' INTEGER ']' { $$ = newlist($2);}
	dimension '[' INTEGER ']' {insert_list($1,$3);$$=$1;}
expr:
	  CHAR		 	{$$ = conc($1);}
	| STRING 		{$$ = cons($1);}         
	| INTEGER               { $$ = coni($1); }
